...
import com.myDownload.youtubedl_android.mapper.VideoInfo;
import com.myDownload.youtubedl_common.SharedPrefsHelper;
import com.myDownload.youtubedl_common.utils.ZipUtils;
...
public class YoutubeDL {
    ...
    public YoutubeDLResponse execute(YoutubeDLRequest request, @Nullable DownloadProgressCallback callback, String title) throws YoutubeDLException, InterruptedException {
        assertInit();
        ...
        StreamProcessExtractor stdOutProcessor = new StreamProcessExtractor(outBuffer, outStream, callback, title);
